...
We support using AI (such as LLMs) as tools when contributing to Probatio.
However, you are responsible for any contributions you submit, and we are
responsible for any contributions we merge and release. We hold a high bar for
